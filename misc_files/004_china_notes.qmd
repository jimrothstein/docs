...
```
## THIS is now QUARTO file:    NEEDS CLEANUP
## It began as *.typ file.  Conversion to *.md is not easy.

## USEAGE: quarto render <file.qmd> --to typst.   
## "typst" here means typst engine.  This renders ONLY to pdf.
