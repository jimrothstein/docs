...
##  News
-  23DEC2024 - convert  back to qmd !  (standardize on one markdown file type)
...
-eGFR 63
-Problem is kidney spilling protein, now 1.78g (used to always be under 1.0 g);  above 3.x  is problem
-
...
T=4 (Fri) 3 BM today;  1st green mud, 'shit in pants' fucking mess everywhere !   2nd green, in toilet, some structure;   3rd  brown, some structure
T=5 (Sat) BM brown, some structure
T=+13 (Sun) (omitted: regular, very elonged swollen feces;
green-brown; some days 'perfect' but some days a little too soft, even
if water clear; I assumed body like beans & burriotes); BUT .. not
last 3 days; today 4 BM!  all elongated, soft, water clear .... but
"Shit-in-pants" b/c can not seem to control; ie hold it in.  When it
comes out ... mess, soft, mud...  So in toliet has structure, but
soft.  On me, it is ccomplete MESS.

#### 05DEC2024 - GI puzzles, but no diarerha since 1st couple weeks post-colonoscopy;
- keffir very beneficial
- some combination of foods (sourdough, salsa, medications ...) triggers angry stomach and copious gas for 12-24 hours. again no direahea.
- Combination because these foods alone, or in other combinations DO NOT cause problem.
- walking + water DOES help, but never needed this before.
- Better able hold stool vs 1st few weeks post-colon.  Not great, but better.  Also stool has darker color.

#### 23DEC2024 - DDS, need to improve 
-  my upper left, rear (last 2 teeth) **FlOSS**,  interdents not cleaning (and do not fit)
-  my lower right, mid, crown - not clean; either **poke** down with
   an interdent brush; brush **lower**; point brush down.  Not
   cleaning area **around gum** enough.
  
#### 02JAN2025 - stool=small redish stones, last 3 days.
- nurse Miluska suspects BEETS, turns stool reddish.   (I drank beet, ginger ... juice; was on sale.)
- took details about last prep (said my 6 pages notes too small, too much to read)
- will send to doctor.
- suggested NEXT prep:   miralax (daily 1 - 2 x) for 7 days; 4 days before liquid diet; then 2 days before gavolite.  (said every doctor has own prep, but she has seen miralax work before.
- I have redundant colon (twists & turns ?) hard to clean.

.
### 08JAN2025 - filed as grievance.
Kaiser does not handle `greivance` - must contact Pacific Source.

- 3rd colonoscopy is pending.
- family history:  colon cancer, my last colonoscopy 8 years ago.

For the 2nd colonoscopy, I was assured by at least 3 Kaiser doctors (+ Kiaser staff) the prep would work.  It did not.  It was 10 day liquid diet which I doubted would work and I TOLD THEM.  

I went home and prompt "shit-in-pants"  on and off next 10 days.

I still have NO answer why it failed.  I have no answers to many questions.  Doctors now proposing 14-day liquid diet, but are clear IT IS NOT BASED ON EVIDENCE.   I

I am not a high school science experiment.

I do not want more than my fair share of scarce medical resources, but I want doctors to do much better than this.   Surely, failed colonoscopies are also expensive. This time please listen to the patient.

### 10JAN2025 Dr. Lam (urology)
Serum Creatine - 1.17 ok
Protein/Creatinine 1.28,  some protein and some glucose in urine (Jardiance can do this)
PSA total is very low (good).  But 'free' value is 14% and ideal is > 25%.  (I am always low.)  So dr.lam not concerned (b/c total so low).  HOWEVER, if PSA went to 2 and then 4 and free was 14%, he would CT of prostate and then biopsy.  
CT scan (was post-colonoscopy) - showed only tiny stone in `meat` of kidney (safe) and no other stones.  CT is much better than KUB, ultrasound.

### 27JAN2025 Laura - case worker from Pacific Health

You have already done quite a bit work on my behalf.  And I thank you for this.

I want to suggest if we focus on 


Prep
- Extract data from last prep, so staff can see where and when it failed.

- Work out schedule of what *should* happen and *by when*.
- I think 10-day prep is actually not needed.

- Establish warning signs in advance.
- Decisions on day procedure day. If pt not ready, discuss options in advance.
- If procedure fails, and there are options (like CT scan) discuss well in advance.

Post
- Again, review what happened last 2 prior times.  Several days of 'shit-in-pants' is not what should happen.

### 5 FEB 2025 - Dr. Miyake, phone
- every 3 months, urine protein + checkin with him
- wants protein value < 1.0  (now 1.28)  > 3.0 is concern.
- BP - goal ~125/75;  not too much lower;  b/c risk for falling increases with age at lower BP.


### 27 FEB 2025 - Dr. Nordstrom   colon prep - no conclusion

- His goal:  what prep do you want?  no time to monitor or adjust if not working, take more laxative or abort
- 30' on phone (then another patient waiting)
- my bowel is extended, twisted?,  SEEDs accumulate and clog probe's pathway. SEEDS?  I had too many SEEDS.
- didn't answer how Dr. Wong (8 yrs age) was able to get through
- I tried to argue more stuff you give me; less OUT.
- A 2-3 day (like at Eugene, Feb '24) had things moving, just not enough time.   Why do I need 14 day prep??
- He repeatedly asked:  14 day or 5 day or what do you want?  2x miralax for 7 days;  then 2-3 days Gavilight. 
- How can I answer? Depends on volume out! and when!  Not sure he grasped that I went to ER b/c nothing coming out.
- FIND OUT:  how does Gavlight work?   Can I take for 5 days??

- Claims:  75-85 not even necessary;  risk greater than reward.
- He's annoyed.  He made it clear that this is how they do it. 
- I said 2nd meeting.  He asked: with him?   I said NO.

### Colonoscopy - telephone with Dr. Jack ...
- 25 years exp, but very new to Kaiser
- trusts patient knows body best
- agrees to OST/Sulfate tablet
- use coupon, cost ~ $50 
- b/c easier, higher compliance rate
- (not better at emptying)
- suggests:  use Miralax, self-enema
- kidney fct - needs to check with Dr. Miyake
- suggested TUES procedure, so **might** be possible to delay to later in week (if not ready)
- said **he** will try to do procedure itself
- only **CON**, back to **virtual (ie CAT)** if all else fails.
- had better feeling than with Nordstrom


### April 2025,  new eyeglasses

SEE  EYE Dr in Salem, OR (kaiser)
- one small cateract in each eye, 5-10 years, but also said NO change from 5 years ago.
...
OLD: Reading
OLD: Daily
NO old driving - stolen 3-4 years ago?

### 19 MAY 2025 - see Dr. xxxxx (primary care)
- Goal: review and prioitized what needs to be done
- Results:  
- A1C - she didn't know what the normal (bell) curve would be.  Recited the bad levels; Finally said wants fasting glucose < 110  (what happened to < 100?) .   My last reading:  126!
- Jardiance:  said it should lower blood glucose; pointed out opposite happens
- Offered test A1C 4x per year.  I accepted.
- BP:  121/73 (on poor sleep) she was happy; no comments when I explained `vigurous rowing` could reduce much futher.  Suggested therapy if lacked motivation.
- Colonoscopy - no discussion except `sorry`.
- Listened to hear/lungs - 5 seconds?
- Showed her hernia.
- On the whole, another **minimalist**; but take what I can get.
- fyi, for seniors Covid shots can be repeated every 12 months.  But new Covid coming in Sept 25.
- return 6 months.

### 20 May 2025  Dr. Miyake:
- happy with BP
- Mg is slightly high (probably diet)
- Ox 79
- agreed to do 24-hour urine TWICE per year
- ultrasound does probe INTERIOR of kidney - useful to doctors; even if false positives
- KUB when clear, will show bright stone (calcium)-  
- Citrate is fine, but a little more (lime in water) even better.


\newpage

### 5 June 2025
Dear Dr McCracken-Schroeder:

(1) What shall I call you?
(2) "success" , at next DEXA scan, should move mineral density from T -3.5   to T less than -2.5.   Am I correct?  I was hoping for a few more details.

(3) Read this paper:  Reid, Ian R., Brown, Burckhardt, Horowitz, Richardson, Trechsel, , et al. “Intravenous Zoledronic Acid in Postmenopausal Women with Low Bone Mineral Density.” NEJM 346, no. 9 (February 28, 2002): 653–61. https://doi.org/10.1056/NEJMoa011807.
Obviously not me, but did refer to increased mineral density 1-5 (vs placebo).   
Would >1 percent be a 'success' for me??  2%? 5%

Thx


### 8 July 2025 - 1st infusion

No issues (as of + 6 hours)
+ 11 hours, feeling a little weak; after gym, shower; fear of fall (holding on tight); no headache or other symptoms;  feels like just stay in bed.   Sit still and don't move; THEN 2-3 days could barely move; seemed very serious;  dispated slowly over next 2-3 days.  CLAIM:  1st infusion is worst.




### 23 Sept 2025 - Dr. Miyake:
-Things labs OK.   Jardiance (+ Losartan) can raise creatine (now 1.38) and lower eGFR (now 55).  Acceptable because long-term benefit.
-Enlarged prostate - but no evidence of worry.   Stay in touch with urology.


### 1 OCT 2025 - prescription check...
As service from Express Scripts, review meds with Pharmacist ...Actually got some good info:   gemfibrozil is good for triglyerides, but statins will do this and do more artery cleaning.  Don't oversdose on D3 (5,000 IU 3-4 times per week is fine.)

### 1 OCT 2025 - flu + covid-19 shots
- definitely felt both shots in arm.
- first 12 hours only sore arm
- but that night - sick, poor sleep, fever, sniffles.....
- and next day - still out of it.
- 48 hours after shot - feel normal.   48 hours
