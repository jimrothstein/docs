...
- \*.qmd, the preferred method is: use quarto, .qmd file, with **format:
  typst**
...
- PROBLEM: often much cleanup; worse lingering typt command (in the
  file.md) may badly trip quarto render.

## (tech_notes) Where is my file?
