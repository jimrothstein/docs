...
(vs Technical Skills) (vs Languages: R, SQL, OS: linux
...
-   OpenAPI: wrote R code to prepare code, requests and convert
    responses to tibbles, inlcuding outh2.
-   Linux (Debian, LinuxMint, Ubuntu): 4+ years, shell scripts, cron
    jobs, Rscripts

### Recent Projects & Skills {#recent}

-   For local government agency, created automated checker for broken website urls.  Wrote specs, used LLM to link github actions and python script.

-   Using quarto + typst, writing backpropagation introduction.
