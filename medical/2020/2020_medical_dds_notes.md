...
<!--
!pandoc % -f markdown --toc -t latex -V linkcolor:blue -V fontsize=11pt -V geometry:margin=0.5in -o ~/Downloads/print_and_delete/out.pdf
...
-	I explain reg dds abou to do cleaning.
...
Suspects low elasete-1 may be FALSE, often diluted.
...
2.  Two key `facts`:  
    ...
    *  Also very clear I have **hyperoxaluria** (high UrOx),  whose value varies widely.    However,
        pancreatic enzymes do not appear to have any affect on UrOx [^2]
...
[^1]: No malnutrition, anemia, diarrhea.
[^2]: Evaluating this with Dr. Lieske (Mayo Clinic)
