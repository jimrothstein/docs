...
<!---
	 vim:linebreak:spell tw=81 fo=tqlnr foldcolumn=3 columns=90
...
In no particular, order here is my list of problems:
...
and bilirubin results. In 2009, another doctor terminated the prescription



When appropriate, hope to also review:

*	KCitrate - daily dose.

*	Vitamin D3, Now: ~15,000 IU per WEEK.

*	Vitamin D3, 	(2017? - spring 2020):   27,000 IU per Week, per OSHU to correct
	parathyroid (did not work).  

*	Calcium Citrate Supplement - ~1000 - 1200 Ca mg per DAY, w/o D3
	(plus dairy, dietary sources).   Is this working?  
...
Chronic Secondary Hyperoxaluria
Reference:  [kidney oxalate]
(https://www.kireports.org/article/S2468-0249(18)30171-2/pdf)
