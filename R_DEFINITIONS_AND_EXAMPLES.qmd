...
file <- "/home/jim/code/try_things_here/BASE/DEFINITIONS_AND_EXAMPLES.qmd"
...
**Referencial Transparency**
    Function f is ref transparent IF replacing x with its value returns same
    result:   x=6,   f(x) == f(6)
    But quote(x) != quote(6)  differ, not referencial transparent
