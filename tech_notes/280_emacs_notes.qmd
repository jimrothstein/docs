...
**emacs** is a gui program;  can run in terminal but then better to use **emacs --daemon**
...
- Beginner: https://protesilaos.com/codelog/2024-11-28-basic-emacs-configuration/
