...
\item
  /he/ he, help, heading\ldots{}
\item
  /\textless he\textgreater/ ``he'' only
\item
  /\textless.he\textgreater/ not ``he'', but ``she'', ``the'' will pass
\item
  \begin{description}
  \tightlist
  \item[: /\textless a move to first line where ``a'' begins]
  /\textgreater last\$
  \end{description}
\end{itemize}
