---
title: 003_tech_Tech Reading.qmd
format:
  typst:
    toc: true
...
Embeds raw `typst` (ex: math)  and `r` chunks and even legacy `latex`
To render:   quarto render 260_typst_example.qmd
(DO NOT use typst watch to render -- many errors)
...
- Navarro LSR:  <https://stats.libretexts.org/Bookshelves/Applied_Statistics/Learning_Statistics_with_R_-_A_tutorial_for_Psychology_Students_and_other_Beginners_(Navarro)> 
- *Bohm Statistics for Physics* <https://www-library.desy.de/preparch/books/vstatmp_engl.pdf> change of variables (SEE 3.4.1, density as volume); Ch 6 Likelihood
...
- Linear Regression: <https://www.andrew.cmu.edu/user/achoulde/94842/lectures/lecture09/lecture09-94842.html#thinking-more-critically-about-linear-regression>
- Stéphanie M. van den Berg <https://bookdown.org/pingapang9/linear_models_bookdown/simple.html>, uses R, intro book with good explanations.
- Darrin Speegle and Bryan Clair <https://probstatsdata.com/>
- <r-statistics.co/>
- <https://cran.r-project.org/doc/contrib/Faraway-PRA.pdf> linear algebra, Faraway
- kaplan, 3rd Ed, Modern DS  https://mdsr-book.github.io/mdsr3e/


### Textbooks - MS level
- Casella and Berger, mathemtically statistics (dry)
- All of Statistics by Larry Wasserman, more readable, similar topics to Casella
- McElreath’s Statistical Rethinking - many really like, more casual 
- Regression and Other Stories by Vehtari and Gelman (et al), also more casual
- Penn State online
- Hogg
...
-   Bicek, Burzykowski:   (interesting approach) https://ema.drwhy.ai/breakDown.html
...
-  Dalpiaz, David  Illinois,  nice intro to regression as fitting polnomial: https://statisticallearning.org/index.html
...
- Robinson (short linear algebra summary) <https://bookdown.org/ts_robinson1994/10EconometricTheorems/>
- Race, Shaina gentle intro to lin alg:, <https://shainarace.github.io/LinearAlgebra/index.html>
- Magalit/Rabinoff: https://math.libretexts.org/Bookshelves/Linear_Algebra/Interactive_Linear_Algebra_(Margalit_and_Rabinoff)
