...
\*\*\* Notes \*\*\* QUARTO and regex: quarto sometimes does not like.
alias grep=‘grep –color=always’ assertion zero-length Lookaround (2
...
echo \$reg str=bacad echo \$str \| grep -P ‘(?\<!b)a’

echo \${line_break} echo “Precendent” reg=‘((ab\|d)e)’ echo \$reg
str=bacade echo \$str \| grep -P ‘((ab\|d)e)’

echo \${line_break} echo “Alternative” reg=‘(ab\|d)e’ echo \$reg
str=bacade echo \$str \| grep -P ‘(ab\|d)’
...
## not a-zA-Z0-9, plus \_ ie ‘\[^\_\[:alnum:\]\]’
...
regex=’()(.\*)\1’ echo “wordXABC” \| grep -P \${regex} echo “word;word”
\| grep -P \${regex} echo “word;word1” \| grep -P \${regex}
...
regex=‘(cat\|dog)\1’ echo “catXcat” \| grep -P \$regex echo “catcatX” \|
grep -P \$regex echo “catdogX” \| grep -P \$regex echo “cd” \| grep -P
‘\[cd\]\1’
...
class \## ERROR, makes no sense. echo “cd” \| grep -P ‘\[cd\]\1’
...
\#+BEGIN_SRC (f)(o+) replace with \1\_\2\_ foo becomes f_oo\_ \#+END_SRC
