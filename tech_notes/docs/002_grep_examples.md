...
if \[ \$n -lt 1 \] then echo “please provide a regex” exit 0 fi

\#exit 99 \# \# assign location for mp3 files (temp only) \#
...
There is no theory of evolution. Only a list of animals Chuck Norris
allows to live.
...
The big bag of bits was bugged. echo “big bad boot” \| grep -E b.g

# l..e exactly 2 characters

You can live like a king but make sure it isn’t a lie. lake loane echo
“big bad boot” \| grep -E b.g
...
“\[1-5a-fx\]” A random set of characters: y, w, a, r, f, 4, 9, 6, 3, p,
x, t
...
\#1 echo “hello” \| grep -E “h” -

2: ? = 0,1 + = 1,n \* = 0,1,n echo “Letter Letter1 LetterA” \| grep -E
“Letter\[0-9\]?”

‘^b\[aou\]t\$’ This line does not match but the next line does. bat
