...
Suppose true function is quadratic and we model as linear.  In most regions error is large and considstently large.  Is this error `bias`?   a failure of the model?
