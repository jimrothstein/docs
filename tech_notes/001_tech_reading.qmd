...
-  Deisenroth, Faiesel et al | Math4ML
  <https://mml-book.github.io/book/mml-book.pdf> *book | linear alg book,
  regression (Ch 9) related videos
  <https://www.youtube.com/playlist?list=PLkxomGYFWp67infnvPmEcqyQqk0q6ntrY>
...
- Siegrist: <https://stats.libretexts.org/Bookshelves/Probability_Theory/Probability_Mathematical_Statistics_and_Stochastic_Processes_(Siegrist)/05%3A_Special_Distributions/5.29%3A_The_Logistic_Distribution>
...
#### Intro to Linear Alg & Models, 
  ...
  *   Rafael genomics - Chapter 4 matrix  (his older stuff is better, but not
    best organization)
  *   Rafael, <http://rafalab.dfci.harvard.edu/dsbook-part-2/> (2020?), esp
