...
-	 Berkeley CRASH
-	 Chollet, Deep Learning for R (not online, no pdf)  phython versions: 
-  Compeau:  
...
-	 https://www.tmwr.org/  
-   Matloff:  ProbStat Book; Ch15.2 - develops logit function
-   Molnar <https://christophm.github.io/interpretable-ml-book/> Ch 5.2
  logistical regression  (explanations!) 
