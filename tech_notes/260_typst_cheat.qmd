...
PURPOSE:  This is *.qmd file with *typst* chunks
USE:   quarto render 260_typst_cheat.qmd --to typst

TODO:  Cleanup, remove remanents of past SCSS, remove what does **not** work.
